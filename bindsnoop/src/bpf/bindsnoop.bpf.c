...
const struct bind_event _event = {0};
...
static int probe_exit(struct pt_regs *ctx, short ver)
{
  ...
  opts.fields.freebind = (1 << INET_FLAGS_FREEBIND___x) & inet_flags ? 1 : 0;
  opts.fields.transparent = (1 << INET_FLAGS_TRANSPARENT___x) & inet_flags ? 1 : 0;
  opts.fields.bind_address_no_port = (1 << INET_FLAGS_BIND_ADDRESS_NO_PORT___x) & inet_flags ? 1 : 0;
